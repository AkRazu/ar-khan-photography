  ...
  if (error) {
    return (
      <div>
        ...
        <Link to='/login'  className="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700 ">Login</Link>
      </div>
    );
  }
  if (error2) {
            ...
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <div>
                ...
                <div className="my-2">
                  ...
                  <FaGoogle/>
                  <p className="p-0 ml-24">Sign up with Google</p>
                  </button>
                </div>
              </div>
              <div>
